...
const Contact = () => {
  ...
  const formSubmit = (e) => {
    e.preventDefault();
    emailjs
      .sendForm("gmail", "template_8q65naw", e.target, "tAXB6JgZJ-Fxhov8P")
      .then(
        (result) => {
            ...
            <div className="left">
              <div className="box box_shodow">
                ...
                <div className="details">
                  ...
                  <br />
                  <p>Phone: +91 9039872765</p>
                  <p>Email: AnshumaanBaaghi25@gmail.com</p> <br />
                  <span>FIND WITH ME</span>
                  <div className="button f_flex">
                    <a
                      target="#"
                      href="https://www.linkedin.com/in/anshumaanbaaghi/"
                    >
